require_relative "spec_helper"
  ...
  before :all  do
    ...
    File.open("./lib/hangman/dictionary.txt", "w+") do |line|
  ...
  describe "#save_data" do
    before :each do
      allow(game).to receive(:save_name).and_return("temp.txt")
    end
    ...
    it "reads the temporarily created file and compares the values" do
      temp_file = File.readlines("temp.txt")
